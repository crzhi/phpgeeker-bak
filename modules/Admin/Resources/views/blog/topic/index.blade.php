                        ...
                        <div class="layui-table-tool">
                            <div class="layui-table-tool-temp">
                                <div class="layui-btn-container">
                                    <a href="{{ route('admin.blog.topic.create') }}" class="layui-btn layui-btn-sm">添加专题</a>
                                </div>
                            </div>
                        </div>
                        @if(count($topics))
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" class="layui-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="title">
                                                    <div class="layui-table-cell laytable-cell-2"><span>专题名</span></div>
                                                </th>
                                        ...
                                        <tbody>
                                            @foreach($topics as $topic)
                                                <tr data-index="{{ $topic->id }}">
                                                    <td data-field="id">
                                                        <div class="layui-table-cell laytable-cell-1">{{ $topic->id }}</div>
                                                    </td>
                                                    <td data-field="title">
                                                        <div class="layui-table-cell laytable-cell-2">{{ $topic->title }}</div>
                                                    </td>
                                                    <td data-field="description">
                                                        <div class="layui-table-cell laytable-cell-3">{{ $topic->description }}</div>
                                                    </td>
                                                    <td data-field="">
                                                        <div class="layui-table-cell laytable-cell-4">
                                                            <a href="{{ route('admin.blog.topic.edit', ['topic'=>$topic->id]) }}" class="layui-btn layui-btn-xs">编辑</a>
                                                            <a class="layui-btn layui-btn-danger layui-btn-xs pg-delete-btn" data-href="{{ route('admin.blog.topic.delete', ['topic'=>$topic->id]) }}">删除</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
