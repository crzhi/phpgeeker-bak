    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">分类回收站</div>
                                                ...
                                                <tr data-index="{{ $category->id }}">
                                                    ...
                                                    <td data-field="">
                                                        <div class="layui-table-cell laytable-cell-4">
                                                            <a class="layui-btn layui-btn-xs layui-btn-normal pg-restore-btn" data-id="{{ $category->id }}" data-href="{{ route('admin.blog.category.restore') }}" >还原</a>
                                                            <a class="layui-btn layui-btn-danger layui-btn-xs pg-destory-btn" data-id="{{ $category->id }}" data-href="{{ route('admin.blog.category.destory') }}">彻底删除</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
