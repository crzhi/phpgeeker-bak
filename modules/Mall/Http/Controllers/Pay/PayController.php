...
namespace Modules\Mall\Http\Controllers\Pay;
...
class PayController extends MallController
{
    ...
    * @return view
    */
    public function payType(Order $order, Request $request)
    {
        // 判断订单是否属于当前用户
        ...
        // 调用支付宝的网页支付
        return view('mall::pay.type', ['order' => $order]);
    }
    ...
    */
    public function payByAlipay(Order $order, Request $request)
    {
        ...
        return app('alipay')->web([
            ...
            'subject'      => '支付 极客商城 的订单：'.$order->no, // 订单标题
        ]);
    }
    ...
    public function alipayReturn()
    {
        try {
            ...
            return view('mall::pages.error', ['msg' => '数据不正确']);
        }

        return view('mall::pages.success', ['msg' => '付款成功']);
    }
